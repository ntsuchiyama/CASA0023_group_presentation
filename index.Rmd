...
- Data: Landsat 8 Operational Land Imager (OLI) Software: QGIS</br>
5. Calculate the : It can be calculated using the brightness temperature and the emissivity of the land surface.
 6. Use the LST to retrieve vegetation information: By comparing the LST of vegetated areas to non-vegetated areas, retrieving information about vegetation density and health.
