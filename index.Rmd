...
- lead by the Nature Conservancy  - conducted in the Maricopa county 
Heat Action Plan 
- participatory process 
- community based approach involving a total of three workshops - total of three neighbourhoods were selected based on temperature, higher risk of heat-related diseases

• Edison-Eastlake Community, Central Phoenix, AZ
- high latino population 
- low home ownership
- progressive impovershment 

- hot walking routes where the community relies on public transportation 
- re-imagining of bus stops 

- Residents would like to see a fund developed that would
help to maintain shade trees, assist with the financial
burden of removing dead trees, and the purchase of
replacement trees. Shade along walking routes, especially
for children on their way to school, is a priority for Lindo
Park-Roesley Park Neighborhood

he community is over two-thirds
Latino but has a sizeable Black population (18%) as
well


- identification of hot spot interventions 

- what this project shows
- 'the ideas are similar across different neighbourhoods, but the specific applications of solutions varied across neighbourhoods'
• Lindo Park-Roesley Park Neighborhood, South
Phoenix, AZ
