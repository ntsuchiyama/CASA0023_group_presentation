...
**Urbanisation as the maindriver of UHI**
- conversion to urban, residential and impervious surfaces leading to higher temperature (citation )
...
- Population expected to double in  expected to double in the next 30 years ()
...
Mainly focusing on ridership but little on thermal conditions, installing shade structures at all bus stop is the only heat action (add source)
]
.pull-right[
**Our Project**</br>
[`Green Bus Stop Project`](https://ntsuchiyama.github.io/CASA0023_group_presentation/)
Planting trees for bus stops and focusing on green space and thermal conditions for achieving policy goals 
]
...
- 2,850 of those stops have passenger shelters
- No tree planting plan for bus stop
- *Nearly 1000 bus stops have no any shade structure*

## Completed Plan
- Planting trees for the top hottest 30% bus stops with no shelters
- Totally planting 300 trees
...
1. Use National Centers for Environmental Information time series data to get average/ highest temperature condition in Phoenix from year 2017 to 2022; </br></br>
...
.pull-right[
![Temperature Map](image/Screenshot 2023-03-19 193222.png)</br></br>
...
- Connect bus stops with LST result through spatial join. (QGIS)</br></br>
- Select bus stops which had a high rate to have high temperature in one year, then select top hottest 30% of those bus stops. These selected bus stops are objects we focus on in near future.]
...
## Limitation
- Remotely sensing data is not multi-source, Landsat 5 and ASTER, can also be used for long-term monitoring of temperature changes.
...
- **A government strategic researcher** is paid $91,839 per year
  + Paid per month = ＄73,238 / 12 = ＄6103
</br>
- **A geographic cartographer** is paid $58,000 per year
  + Paid per month = ＄58,000 / 12 = ＄4833
  
Budget per month = 3 * ＄6103 + 5 * ＄4833 = ＄42474
---
# Project Managemenet
