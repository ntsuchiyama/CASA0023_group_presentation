...
* Known as "the country's hottest and fifth populous city" (Lakhani)
  + Temperature 
     - 
  + Population growth 
     - City growing thorugh "urban sprawl" 
]
...
- Remote sensing data showing conversion to urban, residential and impervious surfaces and decrease in vegetation as the leading cause for the increase in temperature in Phoenix (Wang)
...
- Increase in heat associated deaths yearly 
...
** lacking detail on the specific detais **
...
### Heat Section - 2050 goal (add citation)
...
**However...** Not much progress being made 

---
# UHI and Transporation
** Focus on the transportation - how does the UHI problem intersect with this particular sector?**

Transportation as cause
* Low density city structure based urban sprawl into the deserts increases private vehicle usage 
- 
...
Mainly focusing on ridership but little on thermal conditions, installing shade structures is the only heat action (add source)
]
.pull-right[
**Our Project**</br>
[`Green Bus Stop Project`](https://ntsuchiyama.github.io/CASA0023_group_presentation/)</br>
Planting trees for bus stops and focusing on green space and thermal conditions for increasing bus usage and achieving policy goals 
]
...
- **A government strategic researcher** is paid $91,839 per year
  + Paid per month = ＄91,839 / 12 = ＄7653
</br>
- **A geographic cartographer** is paid $68,900 per year
  + Paid per month = ＄68,900 / 12 = ＄5741
---
# Project Managemenet
